  ...
  return (
    <div className="fixed bottom-4 right-4 z-40">
      ...
      <button
        ...
        className="flex items-center gap-2 px-4 py-2.5 rounded-full bg-slate-900 text-white shadow-xl hover:bg-slate-800 transition-all font-medium text-xs border border-slate-700 active:scale-95"
      >
      ...
      {isOpen && (
        <div className="absolute bottom-12 right-0 w-80 sm:w-96 bg-white/95 backdrop-blur-md rounded-3xl p-5 shadow-2xl border border-slate-200 mt-2 space-y-4 animate-in fade-in slide-in-from-bottom-2">
          ...
          <div className="flex items-center justify-between pb-2 border-b border-slate-100">
            <div className="flex items-center gap-2">
              ...
              <div>
                <h4 className="font-bold text-sm text-slate-900 leading-tight">Wristband Hardware Simulator</h4>
                <p className="text-[11px] text-slate-500">CarePulse Band (00:18:44:11:3A:B7)</p>
              </div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-2 gap-2">
            <button
              ...
              className="flex items-center justify-center gap-2 p-2.5 rounded-2xl bg-orange-50 hover:bg-orange-100 text-orange-700 text-xs font-semibold border border-orange-200 transition-all active:scale-95"
            >
            ...
            <button
              ...
              className="flex items-center justify-center gap-2 p-2.5 rounded-2xl bg-blue-50 hover:bg-blue-100 text-blue-700 text-xs font-semibold border border-blue-200 transition-all active:scale-95"
            >
          ...
          <div className="space-y-3 pt-1 text-xs">
            ...
            <div>
              <div className="flex justify-between font-medium text-slate-700 mb-1">
                ...
                <span className="font-bold text-slate-900">{temp} °C</span>
              </div>
              <input
                type="range"
                min="35.5"
            ...
            <div>
              <div className="flex justify-between font-medium text-slate-700 mb-1">
                ...
                <span className="font-bold text-slate-900">{spo2} %</span>
              </div>
              <input
                type="range"
                min="90"
            ...
            <div className="flex items-center justify-between pt-2">
              <button
                ...
                className="px-3 py-1.5 bg-amber-50 text-amber-700 rounded-xl border border-amber-200 font-semibold hover:bg-amber-100 transition-all text-xs"
              >
                + 150 Steps Walked
              </button>
