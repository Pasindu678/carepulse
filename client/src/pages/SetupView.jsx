...
export default function SetupView({ onContinueToDashboard, onBackToAccount, patient, setPatient, device, setDevice }) {
  ...
  return (
    <div className="flex-1 max-w-[1280px] w-full mx-auto px-4 sm:px-8 py-8 sm:py-12 flex flex-col justify-between transition-colors">
      
      {/* Top Welcome Title */}
      <div className="mb-8 sm:mb-10">
        <span className="text-xs font-bold tracking-widest text-emerald-600 dark:text-emerald-400 uppercase block mb-2">
        ...
        <p className="text-sm sm:text-base text-slate-500 dark:text-slate-400 mt-2 max-w-2xl font-normal">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 sm:gap-8 items-start mb-12">
        ...
        <div className="lg:col-span-6 bg-white dark:bg-slate-900 rounded-3xl p-6 sm:p-8 shadow-[0_4px_30px_rgba(0,0,0,0.03)] dark:shadow-[0_4px_30px_rgba(0,0,0,0.3)] border border-slate-100 dark:border-slate-800 transition-colors">
              ...
              <div>
                ...
                <div className="relative flex items-center">
                  ...
                  <input
                    ...
                    className="w-full pl-9 pr-3 py-2.5 rounded-xl border border-slate-200 dark:border-slate-700 text-sm text-slate-800 dark:text-slate-100 bg-white dark:bg-slate-800 focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500"
                  />
                </div>
              </div>
        ...
        {/* Card 2: Link Watch & Devices */}
        <div className="lg:col-span-6 bg-white dark:bg-slate-900 rounded-3xl p-6 sm:p-8 shadow-[0_4px_30px_rgba(0,0,0,0.03)] dark:shadow-[0_4px_30px_rgba(0,0,0,0.3)] border border-slate-100 dark:border-slate-800 relative overflow-hidden transition-colors">
          
          {/* Mint decorative circular backdrop in top right */}
          <div className="absolute top-0 right-0 w-32 h-32 bg-emerald-50 dark:bg-emerald-950/20 rounded-bl-full pointer-events-none -mr-4 -mt-4 opacity-80"></div>
          ...
          <div className="mb-4">
            <div className="w-12 h-12 rounded-2xl bg-emerald-50 dark:bg-emerald-950/40 border border-emerald-100 dark:border-emerald-800/60 flex items-center justify-center text-emerald-600 dark:text-emerald-400">
          ...
          <div className="flex items-center gap-2 mb-3">
            <div className="relative flex-1 flex items-center">
              ...
              <input
                ...
                className="w-full pl-10 pr-3 py-2.5 rounded-xl border border-slate-200 dark:border-slate-700 text-sm font-mono text-slate-800 dark:text-slate-100 bg-white dark:bg-slate-800 focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500"
              />
            </div>
            ...
            <button
              ...
              className="px-6 py-2.5 rounded-xl bg-blue-600 hover:bg-blue-700 text-white font-semibold text-sm shadow-md transition-all active:scale-95 disabled:opacity-70 flex items-center gap-1.5 cursor-pointer"
            >
          ...
          {/* Device Found Banner */}
          {isDeviceFound ? (
            <div className="mb-3 p-3.5 bg-emerald-50/90 dark:bg-emerald-950/50 border border-emerald-200 dark:border-emerald-800 rounded-2xl flex items-start gap-3 animate-in fade-in duration-300">
              ...
              <div className="text-xs">
                <div className="font-bold text-emerald-900 dark:text-emerald-300 leading-tight">
                  Device Found: CarePulse Smart Band Pro
                </div>
                <div className="text-emerald-700 dark:text-emerald-400 font-mono mt-0.5">
          ...
          <div className="flex items-center gap-2 text-xs font-medium">
            ...
            <span className={isDeviceFound ? 'text-emerald-700 dark:text-emerald-400' : 'text-slate-500 dark:text-slate-400'}>
              {statusMessage}
            </span>
          </div>
      ...
      <div className="flex items-center justify-between pt-6 border-t border-slate-100 dark:border-slate-800">
        ...
        <button
          ...
          className="text-xs sm:text-sm font-semibold text-slate-500 dark:text-slate-400 hover:text-slate-800 dark:hover:text-slate-200 transition-colors flex items-center gap-1.5 cursor-pointer"
        >
